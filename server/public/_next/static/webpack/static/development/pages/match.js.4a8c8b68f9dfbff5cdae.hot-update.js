  ...
  (0, _createClass2["default"])(MatchConnect, [{
    ...
    value: function attachEvents() {
      this.socket.on('test', function (text) {
        ...
        return console.log('client connection');
      }).on('join', function () {
    ...
    value: function connect() {
      ...
      return new Promise(function (resolve) {
        ...
        _this2.socket = io(url);
        _this2.playerId = _this2.socket.id;
        console.log('playerId', _this2.playerId);
...
//# sourceMappingURL=match.js.4a8c8b68f9dfbff5cdae.hot-update.js.map